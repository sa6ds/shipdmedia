...
const CompassIcon = () => (
  <svg viewBox="0 0 24 24" className="size-5" fill="none" aria-hidden>
    ...
    <path d="M15.5 8.5L13.2 13.2L8.5 15.5L10.8 10.8L15.5 8.5Z" stroke="currentColor" strokeWidth="1.5" />
  </svg>
);
...
const ShieldIcon = () => (
  <svg viewBox="0 0 24 24" className="size-5" fill="none" aria-hidden>
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M9.5 12.3L11.2 14L14.8 10.4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);

const SignalIcon = () => (
  <svg viewBox="0 0 24 24" className="size-5" fill="none" aria-hidden>
    <path d="M5 16C7 14 9.2 13 12 13C14.8 13 17 14 19 16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M7.5 12.5C8.8 11.3 10.2 10.7 12 10.7C13.8 10.7 15.2 11.3 16.5 12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M10.6 9.2C11 8.9 11.5 8.7 12 8.7C12.5 8.7 13 8.9 13.4 9.2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    <circle cx="12" cy="17.8" r="1.2" fill="currentColor" />
  </svg>
);

const services = [
  { title: "Influencer Sourcing", icon: ShipIcon },
  { title: "Campaign Strategy", icon: CompassIcon },
  { title: "Creator Whitelisting", icon: ShieldIcon },
  { title: "Paid Amplification", icon: SignalIcon },
];

const metrics = [
  { label: "Average ROAS", value: "4.3x" },
  { label: "Creator Partners", value: "2,000+" },
  { label: "Monthly Views Driven", value: "48M" },
];

export function AgencySections() {
  return (
    <>
      <section id="services" className="py-16 md:py-24 border-t border-border/30">
